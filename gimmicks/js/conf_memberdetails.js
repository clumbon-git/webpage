...
function f_delete_c($id){
	if(window.confirm("指定児童情報を削除します")){
		...
		document.fm_child.p_window_position.value = $(window).scrollTop();
...
function f_deltel($id){
	if(window.confirm("指定電話番号を削除します")){
		...
		document.fm_tel.p_window_position.value = $(window).scrollTop();
...
function f_delmail($id){
	if(window.confirm("指定メールアドレスを削除します")){
		...
		document.fm_mail.p_window_position.value = $(window).scrollTop();
...
function f_edit_c($form, $id){
	...
	document.fm_child_edit.p_window_position.value = $(window).scrollTop();
